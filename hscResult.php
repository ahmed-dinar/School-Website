    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            while($get=mysql_fetch_array($getHSCResultQry)){
                ...
                ?>
                <?php if($test==1){?>
                    <h4 style="background-color:#5C4283;color:#FFFFFF;height:30px;padding-top:3px;text-align:center;">HSC Result of <?php echo $result_year;?></h4>
                <?php } if($result_year==$tempYear-1){?>
                    <h4 style="background-color:#5C4283;color:#FFFFFF;height:30px;padding-top:3px;text-align:center;margin-top:15px;">HSC Result of <?php echo $result_year;?></h4>
